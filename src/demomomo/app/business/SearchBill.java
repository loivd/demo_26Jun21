 ...
 * @author mrloi
 */
public class SearchBill implements Transaction {
    ...
    public String doRequest(List<String> request) throws Exception {
        ...
        try {
            ...
            if(sizeOfParam == 2) {
                String providerId = request.get(1);
                
                List<Bill> lstProviderBill = Config.lstBill.stream()
                                            .filter(x -> providerId.equals(x.getProviderId()))
                                            .collect(Collectors.toList());
                
                if(lstProviderBill == null || lstProviderBill.isEmpty()) {
                    data.addProperty("respCode", "14");
                    data.addProperty("respDesciption", "Sorry! Not found a bill with such providerid.");
                } else {
                ...
                data.addProperty("respCode", "13");
                data.addProperty("respDesciption", "Search bill request is invalid!!!");
            }
